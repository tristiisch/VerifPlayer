...
public class GhostUtils {
	...
	private static OfflinePlayer[] EMPTY_PLAYERS = new OfflinePlayer[0];
	/**
	 * Team of ghosts and people who can see ghosts.
	 */
	private static String GHOST_TEAM_NAME = "Ghosts";

	public static GhostUtils ghostFactory;
	private static long UPDATE_DELAY = 20L;
	...
	public GhostUtils(Plugin plugin) {
		// Initialize
	...
	private void createTask(Plugin plugin) {
		this.task = Bukkit.getScheduler().runTaskTimer(plugin, () -> {
			for (OfflinePlayer member : GhostUtils.this.getMembers()) {
