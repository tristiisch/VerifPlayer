...
public class VerifPlayerGui {
	...
	public static GuiPage PLAYERS_HOME = new GuiPage("&2VerifPlayer", "&2VerifPlayer &7| &aPlayer List", 6, GuiPageVariable.PLAYER);
	public static GuiPage PLAYERS_CPS = new GuiPage("&2VerifPlayer", "&2VerifPlayer &7| &aPlayer CPS", 6, GuiPageVariable.PLAYER);
