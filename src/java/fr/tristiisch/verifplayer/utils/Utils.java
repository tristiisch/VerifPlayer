...
public class Utils {
	...
	public static List<String> replaceAll(List<String> list, Map<String, String> replace) {
	...
	public static String secondsToCalendar(long s) {
		if (s > 60 * 60 * 24) {
			return "**:**";
		} else {
	...
	public static String tickToTime(int s) {
