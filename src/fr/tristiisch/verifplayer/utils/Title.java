...
public class Title {
	...
	public static void sendTitle(final Player player, String title, String subtitle, final int fadeIn, final int stay, final int fadeOut) {
		...
		try {
			...
			final Constructor<?> titleConstructor = Reflection.getClass(ClassEnum.NMS, "PacketPlayOutTitle").getConstructor(Reflection.getClass(ClassEnum.NMS, "PacketPlayOutTitle").getDeclaredClasses()[0],
	...
	/*
	 * public static void sendTitle(final Player player, String title, String
	 * subtitle, final Integer fadeIn, final Integer stay, final Integer fadeOut) {
